...
import gr.hua.dit.fittrack.web.rest.error.RestApiAccessDeniedHandler;
import gr.hua.dit.fittrack.web.rest.error.RestApiAuthenticationEntryPoint;
...
public class SecurityConfig {
    ...
    @Bean
    @Order(2)
    public SecurityFilterChain uiChain(final HttpSecurity http,
