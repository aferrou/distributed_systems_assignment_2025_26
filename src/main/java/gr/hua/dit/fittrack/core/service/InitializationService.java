...
//    }
    ...
    private void initializeTestAccounts() {
        if (personRepository.count() > 1) { // More than just admin
...
//            if (result.success()) {
//                successCount++;
//                LOGGER.info("Created {} account: {}", request.type(), request.username());
//            } else {
//                failCount++;
//                LOGGER.error("Failed to create {} account {}: {}",
//                        request.type(), request.username(), result.errorMessage());
//            }
        }
